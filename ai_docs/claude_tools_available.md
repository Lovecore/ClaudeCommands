...
### [​](https://docs.claude.com/en/docs/claude-code/settings\#permission-settings)  Permission settings
...
## [​](https://docs.claude.com/en/docs/claude-code/settings\#configuration-options)  Configuration options
